...
<div class="container p-4 bg-white rounded">
    <form id="tablas-form" action="{{ route('tablas.guardar', $project->id)}}" method="POST">
            ...
            <div class="d-flex flex-wrap gap-4 mb-4">
                <h3 class="text-center w-100">CALCULO DE MATERIALES</h3>
                <table class="table table-bordered table-sm text-center align-middle" style="min-width:250px;">
                    <thead>
                        <tr>
                ...
                <h3 class="text-center w-100">CALCULO DE MATERIAL PARA LASER-TUBO</h3>
                <table class="table table-bordered table-sm text-center align-middle" style="min-width:250px;">
                    <thead>
                        <tr>
                ...
                <h3 class="text-center w-100">MATERIALES / PRECIO COSTE</h3>
                <table class="table table-bordered table-sm text-center align-middle" style="min-width:250px;">
                    <thead>
                        <tr>
                ...
                <h3 class="text-center w-100">COMERCIAL / TÉCNICO</h3>
                <table class="table table-bordered table-sm text-center align-middle" style="min-width:250px;">
                    <thead>
                        <tr>
                ...
                <h3 class="text-center w-100">CALCULO DE PRECIOS DE CHAPAS</h3>
                <table class="table table-bordered table-sm text-center align-middle" style="min-width:250px;">
                    <thead>
                        <tr>
                            <th class="black text-white">UD</th>
