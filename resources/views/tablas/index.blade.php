...
<div class="container p-4 bg-white rounded">
    <form id="tablas-form" action="{{ route('tablas.guardar', $project->id)}}" method="POST">
        @csrf
        <!-- Fila 1: Producción | Corte | Otros | Materiales -->
        <div class="excel-grid-4">
            ...
            <div class="excel-card">
                <h3>TRABAJOS DE CORTE POR LASER - AGUA</h3>
                <table class="table table-bordered table-sm text-center align-middle">
                    <thead>
                        <tr>
        ...
        <!-- Fila 2: Resumen, precios, apoyo, etc. -->
        <div class="excel-grid">
            ...
            <div class="excel-card">
                <h3>PRECIO DE VENTA TEÓRICO y FINAL</h3>
                <table class="table table-bordered table-sm text-center align-middle mb-3">
                    <thead>
        ...
        <!-- Fila 3: Cálculo de materiales, precios de chapas, comerciales, etc. -->
        <div class="excel-grid">
            <div class="excel-card">
                <h3>CALCULO DE MATERIALES</h3>
                <table class="table table-bordered table-sm text-center align-middle mb-3">
                    <thead>
                        <tr>
                ...
                <h3>CALCULO DE MATERIAL PARA LASER-TUBO</h3>
                <table class="table table-bordered table-sm text-center align-middle mb-3">
                    <thead>
                        <tr>
            ...
            <div class="excel-card">
                <h3>CALCULO DE PRECIOS DE CHAPAS</h3>
                <table class="table table-bordered table-sm text-center align-middle">
                    <thead>
                        <tr>
                            <th class="black text-white">UD</th>
