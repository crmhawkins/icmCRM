    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Crear Nuevo Pedido</h4>
            </div>
        </div>
    </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('numero_pedido') is-invalid @enderror" 
                                           id="numero_pedido" name="numero_pedido" value="{{ old('numero_pedido') }}" required>
                                    @error('numero_pedido')
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('codigo_cliente') is-invalid @enderror" 
                                           id="codigo_cliente" name="codigo_cliente" value="{{ old('codigo_cliente') }}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="date" class="form-control @error('fecha_pedido') is-invalid @enderror" 
                                                   id="fecha_pedido" name="fecha_pedido" value="{{ old('fecha_pedido') }}">
                                            @error('fecha_pedido')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('descripcion_general') is-invalid @enderror" 
                                              id="descripcion_general" name="descripcion_general" rows="3">{{ old('descripcion_general') }}</textarea>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-text">Sube el archivo PDF del pedido para procesarlo con IA</div>
                                    @error('archivo_pdf')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('notas_manuales') is-invalid @enderror" 
                                              id="notas_manuales" name="notas_manuales" rows="3">{{ old('notas_manuales') }}</textarea>
                                ...
                                <div class="alert alert-info">
                                    ...
                                    <strong>Procesamiento con IA:</strong> Una vez creado el pedido, podrás procesarlo con IA para extraer automáticamente la información de las piezas.
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-12">
                                <div class="d-flex justify-content-end">
                                    ...
                                    <button type="submit" class="btn btn-primary">
                                        <i class="mdi mdi-content-save me-1"></i>Crear Pedido
                                    </button>
                                </div>
                            </div>
                        </div>
